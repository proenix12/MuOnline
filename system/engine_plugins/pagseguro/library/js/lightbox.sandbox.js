...
(function() {
	...
	lightbox.setAttribute('src', 'https://sandbox.pagseguro.uol.com.br/checkout/embedded/i-ck.html');
	...
	PagSeguro.Lightbox.prototype = {
		...
		showLightbox : function() {
			...
			$("#PagSeguro").html("Pagar com PagSeguro");
		},
		/**
		 * Hide the lightbox
		 * 
	...
	function _logErrors(e, method){
		var i = new Image();
		i.src = 'https://sandbox.pagseguro.uol.com.br/checkout/fe-logger.jhtml?log='+e.toString()+' at(l:'+e.lineNumber+', c:'+e.columnNumber+')'+'&jsMethod='+method+'&jsOrigin=pagseguro.lightbox.js'
	}
